...
const util = (() => {
    ...
    const timer = () => {
        ...
        const until = document.getElementById('count-down')?.getAttribute('data-time')
        if (!until) {
            return;
        }
    ...
    const tamu = () => {
        ...
        div.innerHTML = `<p class="mt-0 mb-1 mx-0 p-0 text-light">To, </p><h2 class="text-light">${escapeHtml(name)}</h2>`;
...
const theme = (() => {
    ...
    const onLight = () => {
        ...
        const logo_ele = document.querySelectorAll('.bg-logo-dark');

        if (logo_ele.length === 1) {
            logo_ele[0].classList.remove('bg-logo-dark');
            logo_ele[0].classList.add('bg-logo-light');
        }
    ...
    const onDark = () => {
        ...
        const logo_ele = document.querySelectorAll('.bg-logo-light');

        if (logo_ele.length === 1) {
            logo_ele[0].classList.remove('bg-logo-light');
            logo_ele[0].classList.add('bg-logo-dark');
        }
